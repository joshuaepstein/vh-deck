    ...
    'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-zinc-300',
    {
        variants: {
            variant: {
                ...
                ghost2: 'hover:bg-background-100 hover:text-primary-900 dark:hover:bg-background-800 dark:hover:text-primary-50',
                link: 'text-zinc-900 underline-offset-4 hover:underline dark:text-zinc-50',
                // start with a slight zinc background (200) and then become 100 or something
                ghostInverse:
                    'hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-zinc-50',
                primaryGhost:
                    'bg-zinc-200/40 text-primary-900 dark:text-primary-50 dark:bg-zinc-800/40 dark:hover:bg-zinc-800/60 hover:bg-zinc-100/60',
            },
            size: {
